...
import com.woocommerce.auth.Authentication;
import com.woocommerce.auth.HttpBasicAuth;
import com.woocommerce.auth.HttpBearerAuth;
import com.woocommerce.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "http://localhost:8000/wp-json";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/6.9.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8000/wp-json)
     ...
     * @return a {@link com.woocommerce.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.woocommerce.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.woocommerce.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.woocommerce.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.woocommerce.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.woocommerce.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.woocommerce.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.woocommerce.ApiException If fails to update the parameters
     */
     ...
     * @throws com.woocommerce.ApiException If fail to serialize the request body object into a string
     */
