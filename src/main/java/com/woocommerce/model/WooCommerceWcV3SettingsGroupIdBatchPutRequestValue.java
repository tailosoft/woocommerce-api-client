...
public class WooCommerceWcV3SettingsGroupIdBatchPutRequestValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3SettingsGroupIdBatchPutRequestValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3SettingsGroupIdBatchPutRequestValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3SettingsGroupIdBatchPutRequestValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3SettingsGroupIdBatchPutRequestValue>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3SettingsGroupIdBatchPutRequestValue value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3SettingsGroupIdBatchPutRequestValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3SettingsGroupIdBatchPutRequestValue ret = new WooCommerceWcV3SettingsGroupIdBatchPutRequestValue();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3SettingsGroupIdBatchPutRequestValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3SettingsGroupIdBatchPutRequestValue() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3SettingsGroupIdBatchPutRequestValue(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3SettingsGroupIdBatchPutRequestValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3SettingsGroupIdBatchPutRequestValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3SettingsGroupIdBatchPutRequestValue with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3SettingsGroupIdBatchPutRequestValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3SettingsGroupIdBatchPutRequestValue
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3SettingsGroupIdBatchPutRequestValue
     */
    public static WooCommerceWcV3SettingsGroupIdBatchPutRequestValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3SettingsGroupIdBatchPutRequestValue.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3SettingsGroupIdBatchPutRequestValue to an JSON string
     *
     * @return JSON string
     */
