...
public class WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId ret = new WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId
     */
    public static WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerProductId to an JSON string
     *
     * @return JSON string
     */
