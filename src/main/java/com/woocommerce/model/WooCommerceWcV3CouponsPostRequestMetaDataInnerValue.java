...
public class WooCommerceWcV3CouponsPostRequestMetaDataInnerValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3CouponsPostRequestMetaDataInnerValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3CouponsPostRequestMetaDataInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3CouponsPostRequestMetaDataInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3CouponsPostRequestMetaDataInnerValue>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3CouponsPostRequestMetaDataInnerValue value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3CouponsPostRequestMetaDataInnerValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3CouponsPostRequestMetaDataInnerValue ret = new WooCommerceWcV3CouponsPostRequestMetaDataInnerValue();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3CouponsPostRequestMetaDataInnerValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3CouponsPostRequestMetaDataInnerValue() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3CouponsPostRequestMetaDataInnerValue(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3CouponsPostRequestMetaDataInnerValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3CouponsPostRequestMetaDataInnerValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3CouponsPostRequestMetaDataInnerValue with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3CouponsPostRequestMetaDataInnerValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3CouponsPostRequestMetaDataInnerValue
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3CouponsPostRequestMetaDataInnerValue
     */
    public static WooCommerceWcV3CouponsPostRequestMetaDataInnerValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3CouponsPostRequestMetaDataInnerValue.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3CouponsPostRequestMetaDataInnerValue to an JSON string
     *
     * @return JSON string
     */
