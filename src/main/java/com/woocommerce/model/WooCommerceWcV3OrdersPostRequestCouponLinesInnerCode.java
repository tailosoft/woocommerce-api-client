...
public class WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode ret = new WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode
     */
    public static WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersPostRequestCouponLinesInnerCode to an JSON string
     *
     * @return JSON string
     */
