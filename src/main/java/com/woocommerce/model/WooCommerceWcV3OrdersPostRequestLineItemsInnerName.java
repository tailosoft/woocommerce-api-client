...
public class WooCommerceWcV3OrdersPostRequestLineItemsInnerName extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersPostRequestLineItemsInnerName.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersPostRequestLineItemsInnerName.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersPostRequestLineItemsInnerName' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersPostRequestLineItemsInnerName>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersPostRequestLineItemsInnerName value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3OrdersPostRequestLineItemsInnerName read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersPostRequestLineItemsInnerName ret = new WooCommerceWcV3OrdersPostRequestLineItemsInnerName();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersPostRequestLineItemsInnerName: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersPostRequestLineItemsInnerName() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersPostRequestLineItemsInnerName(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersPostRequestLineItemsInnerName.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersPostRequestLineItemsInnerName
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersPostRequestLineItemsInnerName with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerName given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerName
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersPostRequestLineItemsInnerName
     */
    public static WooCommerceWcV3OrdersPostRequestLineItemsInnerName fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersPostRequestLineItemsInnerName.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersPostRequestLineItemsInnerName to an JSON string
     *
     * @return JSON string
     */
