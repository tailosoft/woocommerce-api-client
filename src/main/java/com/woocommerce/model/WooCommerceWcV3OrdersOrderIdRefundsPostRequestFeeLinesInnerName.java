...
public class WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName ret = new WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName
     */
    public static WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestFeeLinesInnerName to an JSON string
     *
     * @return JSON string
     */
