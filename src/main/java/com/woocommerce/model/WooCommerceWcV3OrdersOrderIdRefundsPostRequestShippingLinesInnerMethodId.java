...
public class WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId value) throws IOException {
                ...
                @Override
                public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId ret = new WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId
     */
    public static WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodId to an JSON string
     *
     * @return JSON string
     */
