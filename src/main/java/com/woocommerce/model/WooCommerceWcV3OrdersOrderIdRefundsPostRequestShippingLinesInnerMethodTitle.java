...
public class WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle>() {
                @Override
                public void write(JsonWriter out, WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Boolean, Integer, String");
                }

                @Override
                public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle ret = new WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle() {
        super("anyOf", Boolean.TRUE);
    }

    public WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle(Object o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle with anyOf schemas: BigDecimal, Boolean, Integer, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle
     * @throws IOException if the JSON string is invalid with respect to WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle
     */
    public static WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle.class);
    }

    /**
     * Convert an instance of WooCommerceWcV3OrdersOrderIdRefundsPostRequestShippingLinesInnerMethodTitle to an JSON string
     *
     * @return JSON string
     */
