...
|**version** | **String** | Version of WooCommerce which last updated the order. |  [optional] |
|**status** | [**StatusEnum**](#StatusEnum) | Order status. |  [optional] |
|**currency** | [**CurrencyEnum**](#CurrencyEnum) | Currency the order was created with, in ISO format. |  [optional] |
|**dateCreated** | **OffsetDateTime** | The date the order was created, in the site&#39;s timezone. |  [optional] |
|**dateCreatedGmt** | **OffsetDateTime** | The date the order was created, as GMT. |  [optional] |
|**dateModified** | **OffsetDateTime** | The date the order was last modified, in the site&#39;s timezone. |  [optional] |
|**dateModifiedGmt** | **OffsetDateTime** | The date the order was last modified, as GMT. |  [optional] |
...
|**billing** | [**WooCommerceWcV3OrdersPostRequestBilling**](WooCommerceWcV3OrdersPostRequestBilling.md) |  |  [optional] |
|**shipping** | [**WooCommerceWcV3OrdersPostRequestShipping**](WooCommerceWcV3OrdersPostRequestShipping.md) |  |  [optional] |
...
|**datePaid** | **OffsetDateTime** | The date the order was paid, in the site&#39;s timezone. |  [optional] |
|**datePaidGmt** | **OffsetDateTime** | The date the order was paid, as GMT. |  [optional] |
|**dateCompleted** | **OffsetDateTime** | The date the order was completed, in the site&#39;s timezone. |  [optional] |
|**dateCompletedGmt** | **OffsetDateTime** | The date the order was completed, as GMT. |  [optional] |
...
|**lineItems** | [**List&lt;WooCommerceShopOrderLineItemsInner&gt;**](WooCommerceShopOrderLineItemsInner.md) | Line items data. |  [optional] |
...
|**couponLines** | [**List&lt;WooCommerceShopOrderCouponLinesInner&gt;**](WooCommerceShopOrderCouponLinesInner.md) | Coupons line data. |  [optional] |
|**refunds** | [**List&lt;WooCommerceShopOrderRefundsInner&gt;**](WooCommerceShopOrderRefundsInner.md) | List of refunds. |  [optional] |
|**paymentUrl** | **String** | Order payment URL. |  [optional] |
|**setPaid** | **Boolean** | Define if the order is paid. It will set the status to processing and reduce stock items. |  [optional] |
|**isEditable** | **Boolean** | Whether an order can be edited. |  [optional] |
|**needsPayment** | **Boolean** | Whether an order needs payment, based on status and order total. |  [optional] |
|**needsProcessing** | **Boolean** | Whether an order needs processing before it can be completed. |  [optional] |
|**manualUpdate** | **Boolean** | Set the action as manual so that the order note registers as \&quot;added by user\&quot;. |  [optional] |
